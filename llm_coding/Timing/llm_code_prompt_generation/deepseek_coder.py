...
def main():
    ...
    logger.info("Starting encoding with DeepSeek (prompt generation mode)...")
    ...
    prompt_file = os.path.join(RESULTS_DIR, "generated_prompt_deepseek.txt")
    ...
    # Summary statistics
    print(f"\nENCODING SUMMARY (DEEPSEEK - PROMPT GENERATION)")
    print(f"{'=' * 50}")
