#!/usr/bin/env python3
"""
GPT Coding Replication Script - PROMPT GENERATION VERSION
...
"""
    ...
    def generate_coding_prompt(self):
        ...
        logger.info("Phase 1: Generating coding prompt template from GPT...")
...
Return ONLY the prompt template text, nothing else. Do not wrap it in quotes or code blocks."""
    ...
    def run_full_replication(self, data_dir: str = "../Data", output_dir: str = None) -> Dict[str, pd.DataFrame]:
        logger.info("Starting full GPT coding replication (PROMPT GENERATION)")
        ...
        prompt_file = self.output_dir / "generated_prompt_gpt.txt"
    ...
    def save_results(self, results: Dict[str, pd.DataFrame]):
        ...
        if all_results:
            ...
            output_file = self.output_dir / "gpt_classifications.csv"
