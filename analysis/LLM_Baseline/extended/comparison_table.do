...
file write `fh' "\textbf{Outcome} & \multicolumn{2}{c}{\textbf{Original RA}} & \multicolumn{2}{c}{\textbf{New RA}} & \multicolumn{2}{c}{\textbf{LLM Baseline}} \\" _n
...
file write `fh' "\item \textbf{Panel B (Promises):} \textit{Proportion} = rate of the outcome among Promise-coded vs.\ No-Promise-coded episodes. \(p\)-value is from a one-tailed two-proportion \(z\)-test." _n
